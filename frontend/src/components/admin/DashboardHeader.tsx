...
// import { ThemeToggle } from "@/components/ThemeToggle"; // Removed dark mode toggle
...
const DashboardHeader = () => {
  ...
  // Simple logout handler (clear token/localStorage and redirect)
  const handleLogout = () => {
    localStorage.removeItem("token"); // Adjust key as per your auth logic
    localStorage.removeItem("user"); // Remove user info if stored
    // Optionally clear cookies or call logout API here
    navigate("/login");
  };
      ...
      <div className="container mx-auto px-4 py-3">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center space-x-4">
            ...
            {/* <ThemeToggle /> Removed dark mode toggle */}
            <Button
              variant="outline"
