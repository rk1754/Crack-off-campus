    ...
    try {
      if (form.current) {
        ...
        const result = await emailjs.sendForm(
          "service_omoc41u", // Updated serviceID
          "template_dopujol", // Template ID
          form.current,
          "PkEK-jqv8myEbf6Hi" // Public Key
        )
      ...
      setStatus({
        type: "error",
        message: `Failed to send message: ${error.text || error.message}. Please try again or contact us directly at crackoffcampus63@gmail.com.`,
      })
    } finally {
        ...
        <div className="mt-12 bg-white rounded-lg shadow-lg p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600 mt-1">
                Access to exclusive off-campus job opportunities
              </p>
            </div>
          </div>
        </div>
