...
// Bcrypt Salt
export const BCRYPT_SALT: number =
...
export const SMTP_PORT: number =
  parseInt(process.env.SMTP_PORT as string) || 465;
...
export const FRONTEND_URL_3 =
  process.env.FRONTEND_URL_3 || "http://localhost:8080";
...
export const CASHFREE_ENV = process.env.CASHFREE_ENV as string;
